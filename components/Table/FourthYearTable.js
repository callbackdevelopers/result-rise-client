...
const FourthYearTable = ({fourthYearTable, department, Addmission}) => {
    console.log('second year ', fourthYearTable);

    const { exam_results, season, semester,final_Result } = fourthYearTable;
