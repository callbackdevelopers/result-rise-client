...
const FirstYearTable = ({ firstYearData, department, Addmission }) => {
  console.log("semester final data", firstYearData);

  const { exam_results, season, semester, final_Result } = firstYearData;
  console.log("exam_results", exam_results, final_Result
  );
