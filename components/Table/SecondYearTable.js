...
const SecondYearTable = ({secondYearData, department, Addmission}) => {
    console.log('second year ', secondYearData);

    const { exam_results, season, semester,final_Result } = secondYearData;
